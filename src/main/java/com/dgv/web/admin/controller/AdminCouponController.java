...
public class AdminCouponController {
	...
	@ResponseBody
	public CommonResultDto insertCoupon(@RequestPart("couponVo") AdminCouponVO couponVo,
			@RequestPart MultipartFile imgFile) {
		final FileUploadService.FileUploadResult fileResult = fileUploadService.fileUpload(imgFile, "coupon/",
				couponVo.getCoupon_img());
	...
	@ResponseBody
	public CommonResultDto deleteCoupon(@RequestBody AdminCouponVO vo) {

		int num = adminUserService.couponDelete(vo);
		if (num == 0)
			return CommonResultDto.fail();
		return CommonResultDto.success();
	}
