...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "F90DGSYmFJj2aTeQcGGa";
	private final static String CLIENT_SECRET = "0xfUBz28h4";
	private final static String REDIRECT_URI = "http://localhost/dgvMain.do";
