   ...
   $(function(){
      ...
      $('#password').on('keyup',function(){
         if($(this).val() ==""){
            ...
            $("#psCK").html('<b style="color:orangered; font-size: smaller;">[ 비밀번호는 필수 입력값입니다! ]');
            chk2 = false;
         }else(!getPwCheck.test($("#password").val())){
        	 $("#password").addClass("issetUser");
         ...
         if($("#password").val() != ""){
         	if($('#password').val() != $('#passwordRepeat').val()){
            	 $("#password").addClass("issetUser");
            	 $("#password").addClass("issetUser");
                 $("#psCK").html('<b style="color:orangered; font-size: smaller;">[ 비밀번호가 일치하지 않습니다! ]');
                 chk2 = false;
             }else{
