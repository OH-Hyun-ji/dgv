               ...
               <div "class="myPage-content-wrap">
                  ...
                  <div class="myPage-table-wrap">
                     <span><i class="fas fa-table me-1"
                        style="margin-right: 1%;"></i>1:1문의내역 </span>
                              ...
                              <tr>
                                 ...
                                 <td><c:choose>
                                       <c:when test="${userQnaOneList.dgv_inquiry_status == 1}">
                                          <button id="finishAnswer"
                                             class="w-btn w-btn-gra3 w-btn-gra-anim" type="button"
                        ...
                        <div class="qna-one-wrap01">
                           <div class="qna-often-icon">
                              <i class="far fa-smile-wink"
                                 style="width: 66px; height: 49px; color: dimgrey;"></i>
                           </div>
                           <div class="qna-often-wrapping">
                              <div class="qna-often-title">
                                 <span>자주하시는 질문</span> <input type="button" id="qna-btn"
                                    onclick="location.href='/oftenQna.do'" value="바로가기">
                              </div>
                        ...
                        <div class="qna-one-wrap02">
                           ...
                           <div class="qna-often-wrapping">
                              <div class="qna-often-title" style="margin-top: 18%;">
                                 <span>고객의 말씀</span> <input type="button" id="qna-often-btn"
                                    onclick="location.href='/qnaRegister.do'" value="바로가기">
                              </div>
                              <div class="qna-often-text" style="margin-top: 4%;">
                                 <span>불편사항과 문의사항을 남겨주시면 <br>친절히 답변드리겠습니다.
                                 </span>
