						...
						<div class="myPage-table-wrap"
							...
							<table class="myPage-table">
								...
								<tbody class="clean-list">
									<c:forEach var="userFaqTotalList" items="${userFaqTotalList }" varStatus="status">
										<tr>
											<td>${status.index+1 }</td>
											<td>${userFaqTotalList.kind_name }</td>
											<td><a href="oftenAnswer.do?faq_num=${userFaqTotalList.faq_num}">${userFaqTotalList.faq_title }</a></td>
											<td>${userFaqTotalList.faq_count }</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
