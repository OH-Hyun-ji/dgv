    ...
    <div class="header">
        <div class="header_content">
            <div class="contents">
                <h1>
                    <!-- 상단 로고와 사이드 로고 -->
                    <a><img src="${pageContext.request.contextPath }/resources/images/7.png"></a>
                ...
                <ul class="memberInfo_wrap">
                    <li>
                        <a href="#" title="로그인">
                            <i id="a" class="fas fa-lock"></i>
                            <span id="main1" class="modiImg1">로그인</span>
                        </a>
                    </li>
                    <li><a href="#">
                            <i id="a" class="fas fa-portrait"></i>
                            <span id="main1">회원가입</span>
                        </a>
                    </li>
                    <li><a href="#">
                            <i id="a" class="fas fa-user-alt"></i>
                            <span id="main1">MY DGV</span>
                        </a>
                    </li>
                    <li><a href="#">
                            <i id="a" class="fas fa-hand-holding-heart"></i>
        ...
        <div class="nav">
            <div class="contents"style="left:0px;">
                ...
                <ul class="nav-item">
                    <li>
                        <h2><a class="btn-fix" href="#">영화</a></h2>
        ...
        <div class="movie-wrap">
            <div class="contents">
                <div class="video-wrap">
                    ...
                    <span class="movie-txt">
                        movie-sub-txt-1
                        <br>
                        movie-sub-txt-2
                    </span>
                    <div class="movie-wrap-controller">
                        <a class="movie-detail-btn" href="#">상세보기</a>
                        <a class="movie-stop-btn" href="#">stop</a>
                        <a class="movie-sound-off-btn" href="#">soundOn</a>
                    </div>
        ...
        <div class="contents">
            <div class="movie-chart-btn-wrap">
                <div class="chart-name-wrap">
                    <h3>
                        <a href="#" class="active" id="btnMovie" style="font-weight: bold;font-size: 31px;" >무비차트</a>
                    </h3>
                    <h3>
            ...
            <!-- swiper -->
            <!-- 1번 -->
            <div class="swiper swiper-container-initialized swiper-container-horizontal movie-list" id="movie-list">
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active"
                        ...
                        <div class="img-wrap" data-scale="false">
                            <img src="${pageContext.request.contextPath }/resources/images/84949_320.jpg" alt="제목란인데ㅠ">
                            <div class="movie-age-limit">
                                <img src="${pageContext.request.contextPath }/resources/images/grade-12.png" alt="12세">
                            </div>
                            <div class="movie-hidden-btn">
                                <a href="#" class="movie-detail">"상세보기"</a>
                                <a href--="#" class="movie-ticketing">예매하기</a>
                            </div>
                        </div>
                        <div class="movie-info-wrap">
                            <strong class="movie-name">바나나나</strong>
                            <span>
                    ...
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active"
                        style="width: 170px; margin-right: 32px;">
                        <div class="img-wrap" data-scale="false">
                            <img src="${pageContext.request.contextPath }/resources/images/85229_320.jpg" alt="제목란인데ㅠ">
                            <div class="movie-age-limit">
                                <img src="${pageContext.request.contextPath }/resources/images/grade-15.png" alt="12세">
                            </div>
                            <div class="movie-hidden-btn">
                                <a href="#" class="movie-detail">"상세보기"</a>
                                <a href--="#" class="movie-ticketing">예매하기</a>
                    ...
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active"
                        ...
                        <div class="img-wrap" data-scale="false">
                            <img src="${pageContext.request.contextPath }/resources/images/84949_320.jpg" alt="제목란인데ㅠ">
                            <div class="movie-age-limit">
                                <img src="${pageContext.request.contextPath }/resources/images/grade-all.png" alt="12세">
                            </div>
                            <div class="movie-hidden-btn">
                                <a href="#" class="movie-detail">"상세보기"</a>
                                <a href--="#" class="movie-ticketing">예매하기</a>
                    ...
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active"
                        style="width: 170px; margin-right: 32px;">
                        <div class="img-wrap" data-scale="false">
                            <img src="${pageContext.request.contextPath }/resources/images/1.png" alt="제목란인데ㅠ">
                            <div class="movie-age-limit">
                                <img src="${pageContext.request.contextPath }/resources/images/grade-12.png" alt="12세">
                            </div>
                            <div class="movie-hidden-btn">
                        ...
                        <div class="movie-info-wrap">
                            <strong class="movie-name">바나나나12</strong>
                            <span>
                                <img src="${pageContext.request.contextPath }/resources/images/star.png">
                                10%
                            </span>
                    ...
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active" style="width: 170px; margin-right: 32px;">
                        ...
                        <div class="movie-info-wrap">
                            <strong class="movie-name">바나나나11</strong>
                            <span>
                                <img src="${pageContext.request.contextPath }/resources/images/star.png">
                                10%
                            </span>
                ...
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="다음 슬라이드" aria-disabled="false">
                </div>
                <div class="swiper-button-prev swiper-button-disabled" tabindex="0" role="button" aria-label="이전 슬라이드"
                    aria-disabled="true">
                </div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
            <div class="swiper swiper-container-initialized swiper-container-horizontal movie-list" id="movie-list-reser" style="display: none;">
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper-slide-movie swiper-slide-active"
                        style="width: 170px; margin-right: 32px;">
                        <div class="img-wrap" data-scale="false">
                            <img src="${pageContext.request.contextPath }/resources/images/1.png" alt="제목란인데ㅠ">
                            <div class="movie-age-limit">
                                <img src="${pageContext.request.contextPath }/resources/images/grade-19.png" alt="12세">
                            </div>
                            <div class="movie-hidden-btn">
                                <a href="#" class="movie-detail">"상세보기"</a>
                                <a href--="#" class="movie-ticketing">예매하기</a>
    ...
    <div id="ctl00_PlaceHolderContent_event_wrap" class="event_wrap">
        <div class="contents">
            <div class="event_title_wrap">
                ...
                <a href="#" class="btn_eventControl" >playStop</a>
            </div>
            <div class="event_list_wrap">
                <div class="swiper event_list swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper" style="transition-duration: 300ms; transform: translate3d(-1004px, 0px, 0px);">
                        <div class="swiper-slide" style="width: 310.667px; margin-right: 24px;" >
                            <a href="#">
                                <div class="img_wrap">
                                    <img src="${pageContext.request.contextPath }/resources/images/event1.jpg" alt="신년맞이??" onerror="errorImage(this)">
                                </div>
                                <strong>신년맞이!! dgv챌린지</strong>
            ...
            <div class="noticeClient_container">
                ...
                <div class="qr_wrap">
                    ...
                    <div class="img_wrap" data-scale="false">
                        <img src="${pageContext.request.contextPath }/resources/images/mainQr.png" alt="code">
                    </div>
                    <p>
                        "????????????"
                        <br>
