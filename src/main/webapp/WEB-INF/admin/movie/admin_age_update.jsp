				...
				<div class="card mb-4">
					...
					<div class="card-body">				
                            <div id="table-container">
                            	...
                            	<input type="hidden" id="ageNum" name="movie_age_num" value="${ageList.movie_age_num}">
                            
								<table class="type02">				
									<tr>
										<th scope="row" style="font-size:18px;"">Age Name</th>
										<td><input type="text" id="ageName" name="movie_age_name" value="${ageList.movie_age_name}" style="border-radius: 7px;line-height: 25px;"/></td>
									</tr>
									<tr>
                            ...
                            <div class="bottomBar">
                                <input type="submit" value="Register"  onclick="updateAge()" style="margin-left: 10px;"/>
                            </div>
